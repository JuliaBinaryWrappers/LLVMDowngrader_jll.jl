# `LLVMDowngrader_jll.jl` (v0.2.0+1)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/14769d644c6899dd2c0982a3a90cbe0a0163e035/L/LLVMDowngrader/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/JuliaGPU/llvm-downgrade (revision: `0a26f42f97908f6273b0be75e28895eb9fab166d`)
